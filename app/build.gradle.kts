...
chaquopy {
    defaultConfig {
        ...
        pip {
            ...
            install("setuptools")
            // 命理引擎及其依赖已随「命理功能删除」一并移除
            // （原 pyjhora / pyswisseph / flatlib / lunar_python / cnlunar / ichingshifa /
            //   kinliuren / taixuanshifa / jingjue / meihua-yi / arcanite / stellium 等）
        }
    }
}
android {
    ...
    compileSdk = 37
    defaultConfig {
        applicationId = "me.rerere.rikkasharp"   // 共存版应用ID（与 Rikka+ / RikkaHub 可并存）
        minSdk = 26
        targetSdk = 37
        versionCode = 173
        versionName = "2.4.6"
